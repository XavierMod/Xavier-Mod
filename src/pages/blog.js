...
const Blog = () => {
    ...
    return (
        <Layout>
            <SEO title="Blog" />
            <TopLine>
            <h1>The Mod <span>Hendrix</span> Experience</h1>
            </TopLine>
            <BlogList data={data} />
        </Layout>
    )
